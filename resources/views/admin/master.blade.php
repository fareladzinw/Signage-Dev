...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ route('adminHomepage') }}" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <a href="{{url ('admin')}}"><li class="header">ADMIN MENU</li></a>
        <!-- Optionally, you can add icons to the links -->
        <li class="{{ (request()->is('admin/player/*')) ? 'treeview active' : 'treeview' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ (request()->is('admin/player/master-media')) ? 'active' : '' }}"><a href="{{url ('admin/player/master-media')}}"><i class="fa fa-link"></i> <span>Master Media</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    {{-- <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">daftarPaket</li>
      </ol>
    </section> --}}
